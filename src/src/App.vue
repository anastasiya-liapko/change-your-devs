...
<style lang="sass">
  ...
  .container_result-1
    ...
    background-image: url('/img/back-result-4.png')
    &::before,
    &::after
  ...
  .container_result-2
    ...
    background-image: url('/img/back-result-3.png')
    &::before,
    &::after
      background-color: #ffffff
    .btn_repeat
  ...
  .container_result-3
    ...
    background-image: url('/img/back-result-2.png')
    &::before,
    &::after
      background-color: #ffffff
    .btn_repeat
  ...
  .container_result-4
    ...
    background-image: url('/img/back-result-1.png')
    &::before,
    &::after
      background-color: #ffffff
    .btn_repeat
